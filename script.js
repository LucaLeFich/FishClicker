...
const NEWS_LINES = [
  ...
  'Fish economy surpasses GDP of seventeen nations. Finance ministers refuse to comment.',
  'Roulette wheel demands union representation. Management says it will "spin on it."',
  'Breaking: man discovers idle mode. Describes experience as "cheating but legal."',
  'Philosopher asks: if a fish is caught and no one is there to click, does it count? Game says yes.',
  'Update: the fish do not consent. Legal team says it does not matter.',
  'Ocean Deity spotted at open mic night. Set described as "vast, unknowable, and 40 minutes too long."',
  'Area man achieves fish singularity. Wife asks him to please come to dinner.',
  'Kraken submits quarterly earnings report. Analysts impressed. Also terrified.',
  'New study finds clicking fish linked to happiness, poor posture, and mild megalomania.',
  'Fish dimension zoning dispute escalates. Three realities condemned.',
  'Local submarine surfaced briefly to ask if anyone wanted snacks. Nobody was surprised.',
  'Breaking: time traveller arrives from the future. Refuses to say how many fish you end up with.',
  'Man trawler fleet now exceeds size of NATO navy. Several admirals have sent politely worded letters.',
  'Man builds PC specifically to run FishClicker. "Worth it," he says, not looking up.',
  'Ocean files noise complaint against fish dimension. Case dismissed due to lack of a judge brave enough.',
  'Scientists confirm fish are aware of being clicked. They have chosen to accept their fate.',
  'Fish Dock workers demand higher wages. You give them nothing. They stay anyway.',
  'Breaking: fish clicker player blinks. Nation holds its breath.',
  'Rowboat retrofitted with espresso machine. Productivity up 400%. Crew very jittery.',
  'Anonymous tip: the fish portal leads somewhere wonderful. Nobody who went in has come back to confirm.',
  '"I thought I was the one fishing," admits local man. "Turns out the fish have been farming me."',
  'Fish Star collapses into black hole. Authorities declare it "probably safe."',
  'Man attempts to explain FishClicker to grandmother. She now has more fish than him.',
  'Local deity rated 4.2 stars on Glassdoor. Main complaint: "existence-threatening work environment."',
  'Economists warn fish bubble may burst. Fish do not care. Fish never cared.',
  'New research: the clicking sound is making the fish nervous. Researchers also nervous.',
  'Breaking: idle player accumulates more wealth than most countries while asleep. Experts baffled.',
  'Fish dimension landlord raises rent again. Tenant fish stage silent protest. Nobody notices.',
  'Man clicks fish for the millionth time. His hands have become one with the mouse.',
  'Kraken seen reading a motivational poster. The poster says "hang in there." Kraken does not find it funny.',
  'Local fishing rod achieves enlightenment after being cast 10,000 times. Rod unavailable for comment.',
  'Scientists baffled by fish that generates fish. Leading theory: "it just does."',
  'Breaking: player accidentally closes tab. Reopens immediately. Fish were fine. Player was not.',
  'Sea creatures demand representation in government. Kraken already has a lobbyist.',
  'Man names each of his 300 rowboats. Admits he is running out of ideas after "Gerald CCXLVII."',
  'Fish portal zoning approved. Neighbours describe wormhole as "a bit loud but mostly fine."',
  'Ocean Deity spotted grocery shopping. Asked about tentacle hygiene. Deity declined to comment.',
  '"We did not see this coming," admits every economist simultaneously.',
  'Local woman sets world record for fish production. Asks what the old record was. Nobody knew.',
  'Fish Farm issues IPO. Shares immediately consumed by larger fish. Circle of life.',
  'Breaking: the kraken has a personal trainer. Results described as "alarming."',
  'Submarine crew celebrates 1,000 days underwater. Morale described as "fine, probably."',
  'Player spends three hours optimising build order. Gains four extra fish per second. Worth it.',
  '"The fish are not going to click themselves," says man who has automated the clicking.',
];
